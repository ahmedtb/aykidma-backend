...
export default function SideMenue(props) {
    ...
    return (
        <div class="col-2 d-flex flex-column p-3 bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="#" class="nav-link active">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-keyboard-fill mr-2" viewBox="0 0 16 16">
                            <path
                ...
                <li>
                    <a href="#" class="nav-link link-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-table mr-3" viewBox="0 0 16 16">
                            <path
                ...
                <li>
                    <a href="#" class="nav-link link-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-box mr-3" viewBox="0 0 16 16">
                            <path
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle"
                    ...
                    <img src="https://github.com/mdo.png" alt="" width="32" height="32" class="rounded-circle mr-2" />
